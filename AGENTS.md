...
この repo は `blender-asset-artifact-catalog` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\BlenderAddon\blender-asset-artifact-catalog`
- Domain: BlenderAddon
- Product kind: blender-addon
- Source pack: `D:/AI/BlenderAddon/created_idea_005_blender-asset-artifact-catalog/idea_005_blender-asset-artifact-catalog.zip`
- Public repo: `https://github.com/Sunmax0731/blender-asset-artifact-catalog`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/BlenderAddon/created_idea_005_blender-asset-artifact-catalog` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
